    ...
    <main class="container">
        ...
        <div class="card">
            ...
            <div class="card-body col-auto">
                <form class="col-form-control" action="<?php echo e(url('/')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                ...
                <h3>Task Lisk</h1>
                    ...
                    <div class="table-responsive-sm d-flex">
                        <table class="table table-striper table-bordered table-responsive">
                            <thead>
                                <tr>
                                    <th class="table-primary col-2 justify-center" scope="col">Action</th>
                                    <th class="table-primary" scope="col">Task</th>
                                </tr>
                            </thead>
                            <tbody>
...
<?php /**PATH C:\Users\optimus\Todo_List_Laravel\resources\views/task/index.blade.php ENDPATH**/ ?>